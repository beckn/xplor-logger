        ...
        this.logger = winston.createLogger({
            ...
            format: winston.format.combine(
                ...
                winston.format.printf(({ level, message, timestamp }) => {
                    ...
                    return `[Nest] ${process.pid} - ${timestamp} ${level.toUpperCase()} [${this.serviceName}] ${message}`;
                }),
            ),
            ...
            transports: [
                ...
                new LokiTransport({
                    ...
                    labels: { app: this.serviceName, method: this.job ? this.job : METHOD.default }, // Set labels for Loki.

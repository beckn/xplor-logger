...
export class GrafanaLoggerController {
 ...
 sendLog(@Body() logger: LogMessageDto) {
    ...
    return this.loggerService.log(logger.serviceName, logger.message, logger.methodName);
 }
 ...
 sendError(@Body() logger: LogMessageDto) {
    ...
    return this.loggerService.error(logger.serviceName, logger.message, logger.methodName);
 }
 ...
 sendDebug(@Body() logger: LogMessageDto) {
    ...
    return this.loggerService.debug(logger.serviceName, logger.message, logger.methodName);
 }
 ...
 sendWarn(@Body() logger: LogMessageDto) {
    ...
    return this.loggerService.warn(logger.serviceName, logger.message, logger.methodName);
 }
 ...
 sendVerbose(@Body() logger: LogMessageDto) {
    ...
    return this.loggerService.verbose(logger.serviceName, logger.message, logger.methodName);
 }
}